...
if (mysqli_connect_errno()) 
{
  ...
  $en = $_POST['einrichtung'];
	...
	$query = "SELECT t16field01, t16field02, t16field03, t16field04, t16field05, t16field06, t16field07, t16field08, t16field09, t16field10, t16field11 FROM tbl_form_ebqe_t16 WHERE id_orga_Einrichtung = '$en'
...
if($numrows > 0)  
	...
	$dock11 =$row['t16field11'];
	  ...
	  echo   $dock01.':' .$dock02.':' .$dock03.':' .$dock04.':' .$dock05.':' .$dock06.':' .$dock07.':' .$dock08.':' .$dock09.':' .$dock10.':' .$dock11.':';
