...
namespace App6
{
    ...
    public partial class FirstPage_2019_2 : ContentPage, INotifyPropertyChanged
    {
        public FirstPage_2019_2()
        {
            InitializeComponent();
        }
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                App.user.selected_mstr_ebqe = 14;
        ...
        private async void Logout_button_Tapped(object sender, EventArgs e)
        {
