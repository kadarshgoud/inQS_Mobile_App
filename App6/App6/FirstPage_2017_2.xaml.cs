...
namespace App6
{
    ...
    public partial class FirstPage_2017_2 : ContentPage, INotifyPropertyChanged
    {
        public FirstPage_2017_2()
        {
            InitializeComponent();
        }
        ...
        {
            Navigation.PushAsync(new FirstPage_2017_1());
        }
