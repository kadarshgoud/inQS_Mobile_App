...
namespace App6
{
    ...
    public partial class FirstPage_2018_1 : ContentPage, INotifyPropertyChanged
    {
        public FirstPage_2018_1()
        {
            InitializeComponent();
        }
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                App.user.selected_mstr_ebqe = 11;
        ...
        {
            Navigation.PushAsync(new FirstPage_2018_2());
        }

        private void TapGestureRecognizer_Tapped(object sender, EventArgs e)
        {
            Navigation.PushAsync(new FirstPage_2017_2());
        }
